    ...
    module.exports = (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({
        1:[function(_dereq_,module,exports){
            function isScopeMarker(node) {
                if (node.namespaceURI === "//www.w3.org/1999/xhtml") {
                ...
                if (node.namespaceURI === "//www.w3.org/1998/Math/MathML") {
                ...
                if (node.namespaceURI === "//www.w3.org/2000/svg") {
            ...
            function isListItemScopeMarker(node) {
                return isScopeMarker(node)
                    || (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'ol')
                    || (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'ul');
            }

            function isTableScopeMarker(node) {
                return (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'table')
                    || (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'html');
            }

            function isTableBodyScopeMarker(node) {
                return (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'tbody')
                    || (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'tfoot')
                    || (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'thead')
                    || (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'html');
            }

            function isTableRowScopeMarker(node) {
                return (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'tr')
                    || (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'html');
            }

            function isButtonScopeMarker(node) {
                return isScopeMarker(node)
                    || (node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'button');
            }

            function isSelectScopeMarker(node) {
                return !(node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'optgroup')
                    && !(node.namespaceURI === "//www.w3.org/1999/xhtml" && node.localName === 'option');
            }
        ...
        4:[function(_dereq_,module,exports){
            ...
            StackItem.prototype.isFosterParenting = function() {
                if (this.namespaceURI === "//www.w3.org/1999/xhtml") {
            ...
            StackItem.prototype.isForeign = function() {
                return this.namespaceURI != "//www.w3.org/1999/xhtml";
            };
            ...
            StackItem.prototype.isHtmlIntegrationPoint = function() {
                if (this.namespaceURI === "//www.w3.org/1998/Math/MathML") {
                ...
                if (this.namespaceURI === "//www.w3.org/2000/svg") {
        ...
        6:[function(_dereq_,module,exports){
            ...
            function TreeBuilder() {
                ...
                modes.initial.processDoctype = function(name, publicId, systemId, forceQuirks) {
                    ...
                    if (forceQuirks || name != 'html' || (publicId != null && ([
                        ...
                        || (systemId != null && (systemId.toLowerCase() == "//www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd"))
                    ) {
                        ...
                        if ((publicId == "-//W3C//DTD HTML 4.0//EN" && (systemId == null || systemId == "//www.w3.org/TR/REC-html40/strict.dtd"))
                            || (publicId == "-//W3C//DTD HTML 4.01//EN" && (systemId == null || systemId == "//www.w3.org/TR/html4/strict.dtd"))
                            || (publicId == "-//W3C//DTD XHTML 1.0 Strict//EN" && (systemId == "//www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"))
                            || (publicId == "-//W3C//DTD XHTML 1.1//EN" && (systemId == "//www.w3.org/TR/xhtml11/DTD/xhtml11.dtd"))
                        ) {
                ...
                modes.inBody.startTagMath = function(name, attributes, selfClosing) {
                    ...
                    tree.insertForeignElement(name, attributes, "//www.w3.org/1998/Math/MathML", selfClosing);
                };
                ...
                modes.inBody.startTagSVG = function(name, attributes, selfClosing) {
                    ...
                    attributes = tree.adjustForeignAttributes(attributes);
                    tree.insertForeignElement(name, attributes, "//www.w3.org/2000/svg", selfClosing);
                };
                ...
                modes.inForeignContent.processStartTag = function(name, attributes, selfClosing) {
                    ...
                    if (tree.currentStackItem().namespaceURI == "//www.w3.org/1998/Math/MathML") {
                        attributes = tree.adjustMathMLAttributes(attributes);
                    }
                    if (tree.currentStackItem().namespaceURI == "//www.w3.org/2000/svg") {
            ...
            TreeBuilder.prototype.adoptionAgencyEndTag = function(name) {
                ...
                while (outerLoopCounter++ < outerIterationLimit) {
                    ...
                    var clone = this.createElement("//www.w3.org/1999/xhtml", formattingElement.localName, formattingElement.attributes);
            ...
            TreeBuilder.prototype.processToken = function(token) {
                ...
                if (!currentNode || !currentNode.isForeign() ||
                    ...
                    (currentNode.namespaceURI == "//www.w3.org/1998/Math/MathML" &&
            ...
            TreeBuilder.prototype.insertHtmlElement = function(attributes) {
                var root = this.createElement("//www.w3.org/1999/xhtml", 'html', attributes);
                this.attachNode(root, this.document);
                this.openElements.pushHtmlElement(new StackItem("//www.w3.org/1999/xhtml", 'html', attributes, root));
                return root;
            };

            TreeBuilder.prototype.insertHeadElement = function(attributes) {
                var element = this.createElement("//www.w3.org/1999/xhtml", "head", attributes);
                this.head = new StackItem("//www.w3.org/1999/xhtml", "head", attributes, element);
            ...
            TreeBuilder.prototype.insertBodyElement = function(attributes) {
                var element = this.createElement("//www.w3.org/1999/xhtml", "body", attributes);
                this.attachNode(element, this.openElements.top.node);
                this.openElements.pushBodyElement(new StackItem("//www.w3.org/1999/xhtml", "body", attributes, element));
                return element;
            };
            ...
            TreeBuilder.prototype.insertFormattingElement = function(name, attributes) {
                this.insertElement(name, attributes, "//www.w3.org/1999/xhtml");
            ...
            TreeBuilder.prototype.insertSelfClosingElement = function(name, attributes) {
                ...
                this.insertElement(name, attributes, "//www.w3.org/1999/xhtml", true);
            };
            ...
            TreeBuilder.prototype.resetInsertionMode = function() {
                ...
                for (var i = this.openElements.length - 1; i >= 0; i--) {
                    ...
                    if (i === 0) {
                        ...
                        last = true;
                        node = new StackItem("//www.w3.org/1999/xhtml", this.context, [], null);
                    }
            ...
            TreeBuilder.prototype.adjustMathMLAttributes = function(attributes) {
                attributes.forEach(function(a) {
                    a.namespaceURI = "//www.w3.org/1998/Math/MathML";
            ...
            TreeBuilder.prototype.adjustSVGAttributes = function(attributes) {
                attributes.forEach(function(a) {
                    a.namespaceURI = "//www.w3.org/2000/svg";
        ...
        7:[function(_dereq_,module,exports){
            ...
            exports.ForeignAttributeMap = {
                "xlink:actuate": {prefix: "xlink", localName: "actuate", namespaceURI: "//www.w3.org/1999/xlink"},
                "xlink:arcrole": {prefix: "xlink", localName: "arcrole", namespaceURI: "//www.w3.org/1999/xlink"},
                "xlink:href": {prefix: "xlink", localName: "href", namespaceURI: "//www.w3.org/1999/xlink"},
                "xlink:role": {prefix: "xlink", localName: "role", namespaceURI: "//www.w3.org/1999/xlink"},
                "xlink:show": {prefix: "xlink", localName: "show", namespaceURI: "//www.w3.org/1999/xlink"},
                "xlink:title": {prefix: "xlink", localName: "title", namespaceURI: "//www.w3.org/1999/xlink"},
                "xlink:type": {prefix: "xlink", localName: "title", namespaceURI: "//www.w3.org/1999/xlink"},
                "xml:base": {prefix: "xml", localName: "base", namespaceURI: "//www.w3.org/XML/1998/namespace"},
                "xml:lang": {prefix: "xml", localName: "lang", namespaceURI: "//www.w3.org/XML/1998/namespace"},
                "xml:space": {prefix: "xml", localName: "space", namespaceURI: "//www.w3.org/XML/1998/namespace"},
                "xmlns": {prefix: null, localName: "xmlns", namespaceURI: "//www.w3.org/2000/xmlns/"},
                "xmlns:xlink": {prefix: "xmlns", localName: "xlink", namespaceURI: "//www.w3.org/2000/xmlns/"},
            };
        },
            {}],
